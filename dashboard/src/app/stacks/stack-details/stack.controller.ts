...
export class StackController {
   ...
   * @param $event
   */
  showAddMachineDialog($event: MouseEvent, environmentKey: string): void {
    this.$mdDialog.show({
      targetEvent: $event,
      ...
      locals: {
        ...
        environments: this.stack.workspaceConfig.environments,
   ...
   * @param environments
   */
  setEnvironments(environments: Map<any>) {
    this.stack.workspaceConfig.environments = environments;
    this.updateJsonFromStack();
  }
